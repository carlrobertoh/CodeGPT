...
public class PersonaComboBoxAction extends ComboBoxAction {
    ...
    protected @NotNull DefaultActionGroup createPopupActionGroup(JComponent button) {
        ...
        if (missingDefaultPersona) {
            settings.getPersonas().add(new Persona("No Persona", "Choose this persona if you want the default system prompt."));
            group.add(createPersonaAction(new Persona("No Persona", "Choose this persona if you want the default system prompt."), getTemplatePresentation()));
        }
        group.addSeparator();
            ...
            saveButton.addActionListener(e1 -> {
                ...
                if (selectedName != null) {
                    ...
                    if (selectedPersona != null) {
                        ...
                        selectedPersona.setPromptText(promptField.getText());
            ...
            deleteButton.addActionListener(e1 -> {
                ...
                if (selectedName != null && !selectedName.equals("No Persona")) {
                    ...
                    if (selectedPersona != null) {
                        ...
                        if (doUpdateTemplatePresentation) {
                            settings.setSelectedPersona(settings.getRandomPersona());
                            updateTemplatePresentation(settings.getSelectedPersona());
                        }
                    }
                }
        ...
        public void actionPerformed(@NotNull AnActionEvent e) {
            ...
            okButton.addActionListener(e1 -> {
                ...
                if (!name.isEmpty() && !promptText.isEmpty()) {
                    Persona newPersona = new Persona(name, promptText);
