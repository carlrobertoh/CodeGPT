...
//    commandLine.withWorkDirectory(CodeGPTPlugin.getLlamaSourcePath());
    String modelId = params.isUseCustomModel() ? params.getCustomModelId()
        : params.getSelectedModel().getModelTag();
...
//    commandLine.withWorkDirectory(CodeGPTPlugin.getLlamaSourcePath());
    String model = params.isUseCustomModel() ? params.getCustomModelId()
        : params.getSelectedModel().getModelTag();
    commandLine.addParameters("run", model);
    commandLine.setRedirectErrorStream(false);
    return commandLine;
  }
