...
public class DownloadOllamaModelAction extends AnAction {

  private static final Logger LOG = Logger.getInstance(DownloadOllamaModelAction.class);
  ...
  public DownloadOllamaModelAction(
