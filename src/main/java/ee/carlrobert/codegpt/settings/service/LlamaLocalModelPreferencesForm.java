...
public class LlamaLocalModelPreferencesForm {
  ...
  private final ComboBox<LlamaHuggingFaceModel> huggingFaceModelComboBox;
  private final JBLabel modelExistsIcon;
  private final DefaultComboBoxModel<LlamaHuggingFaceModel> huggingFaceComboBoxModel;
  ...
  private final LlamaLocalSettings settings;

  public LlamaLocalModelPreferencesForm(LlamaLocalSettings settings) {
    ...
    browsableCustomModelTextField.setText(settings.getCustomModel());
  ...
  public ComboBox<LlamaHuggingFaceModel> getHuggingFaceModelComboBox() {
  ...
  public LlamaHuggingFaceModel getSelectedModel() {
    return (LlamaHuggingFaceModel) huggingFaceComboBoxModel.getSelectedItem();
  }
  ...
  public String getActualModelPath() {
    return isUseCustomLlamaModel()
        ...
        : CodeGPTPlugin.getLlamaModelsPath() + File.separator + getSelectedModel().getId();
  }
  ...
  private String getHuggingFaceModelDetailsHtml(LlamaHuggingFaceModel model) {
  ...
  private ComboBox<ModelSize> createModelSizeComboBox(
      ...
      DefaultComboBoxModel<ModelSize> modelSizeComboBoxModel,
      DefaultComboBoxModel<LlamaHuggingFaceModel> huggingFaceComboBoxModel) {
  ...
  private ComboBox<LlamaHuggingFaceModel> createHuggingFaceComboBox(
      DefaultComboBoxModel<LlamaHuggingFaceModel> huggingFaceComboBoxModel,
    ...
    comboBox.addItemListener(e -> {
      var selectedModel = (LlamaHuggingFaceModel) e.getItem();
  ...
  private boolean isModelExists(LlmModel model) {
        ...
        new DownloadModelAction(
            ...
            () -> SwingUtilities.invokeLater(() -> {
              ...
              actionLinkWrapper.setVisible(false);
                  settings.setLlmModel(
                      (LlamaHuggingFaceModel) huggingFaceComboBoxModel.getSelectedItem());
            }),
            (error) -> {
  ...
  private void updateModelHelpTooltip(LlamaHuggingFaceModel model) {
