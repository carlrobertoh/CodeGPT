...
public class WatsonxSettingsForm {
  ...
  public WatsonxSettingsForm(WatsonxSettingsState settings) {
    ...
    onCloudAuthenticationFieldPanel = new UI.PanelFactory().grid()
        ...
        .add(UI.PanelFactory.panel(regionComboBox)
            ...
            .withComment(
                CodeGPTBundle.get("settingsConfigurable.service.watsonx.cloudRegion.comment"))
            .resizeX(false))
        .add(UI.PanelFactory.panel(apiKeyField)
            .withLabel(
                CodeGPTBundle.get("settingsConfigurable.service.watsonx.onCloudApiKey.label"))
            .withComment(CodeGPTBundle.get(
    ...
    deploymentIdField = new JBTextField(settings.getSpaceId(), 35);
    temperatureField = new JBTextField(String.valueOf(settings.getTemperature()), 17);
    topKField = new JBTextField(String.valueOf(settings.getTopK()), 17);
    topPField = new JBTextField(String.valueOf(settings.getTopP()), 17);
    repetitionPenaltyField = new JBTextField(String.valueOf(settings.getRepetitionPenalty()), 17);
    randomSeedField = new JBTextField(
        settings.getRandomSeed() == null ? "" : String.valueOf(settings.getRandomSeed()), 17);
    maxNewTokensField = new JBTextField(String.valueOf(settings.getMaxNewTokens()), 17);
    minNewTokensField = new JBTextField(String.valueOf(settings.getMinNewTokens()), 17);
    ...
    return FormBuilder.createFormBuilder()
        ...
        .addComponent(UI.PanelFactory.grid()
            ...
            .add(UI.PanelFactory.panel(modelComboBox)
                ...
                .resizeX(false))
            .add(UI.PanelFactory.panel(deploymentIdField)
                .withLabel("Deployment ID:")
                .withComment(CodeGPTBundle.get(
                    "settingsConfigurable.service.watsonx.deploymentId.comment"))
                .resizeX(false))
            .createPanel())
        ...
        .addComponent(UI.PanelFactory.grid()
            ...
            .add(UI.PanelFactory.panel(minNewTokensField)
                .withLabel(
                    CodeGPTBundle.get("settingsConfigurable.service.watsonx.minNewTokens.label"))
                .withComment(CodeGPTBundle.get(
                    "settingsConfigurable.service.watsonx.minNewTokens.comment"))
                .resizeX(false))
            .add(UI.PanelFactory.panel(stopSequencesField)
                .withLabel(
                    CodeGPTBundle.get("settingsConfigurable.service.watsonx.stopSequences.label"))
                .withComment(CodeGPTBundle.get(
  ...
  public WatsonxSettingsState getCurrentState() {
    ...
    state.setDeploymentId(deploymentIdField.getText());
    ...
    state.setRandomSeed(
        randomSeedField.getText().isEmpty() ? null : Integer.valueOf(randomSeedField.getText()));
  ...
  public void resetForm() {
    ...
    deploymentIdField.setText(state.getDeploymentId());
    ...
    randomSeedField.setText(
        state.getRandomSeed() == null ? "" : String.valueOf(state.getRandomSeed()));
