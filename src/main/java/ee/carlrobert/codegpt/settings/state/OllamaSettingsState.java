...
import ee.carlrobert.codegpt.completions.ollama.OllamaModel;
...
public class OllamaSettingsState implements PersistentStateComponent<OllamaSettingsState> {
  ...
  private OllamaModel model = OllamaModel.CODE_LLAMA_7B_Q4;
  ...
  public boolean isModified(ServiceSelectionForm serviceSelectionForm) {
    ...
    return serverPort != serviceSelectionForm.getLlamaServerPort()
        ...
        || model != modelPreferencesForm.getSelectedModel()
  ...
  public void reset(ServiceSelectionForm serviceSelectionForm) {
    var modelPreferencesForm = serviceSelectionForm.getLlamaModelPreferencesForm();
    modelPreferencesForm.setSelectedModel(model);
